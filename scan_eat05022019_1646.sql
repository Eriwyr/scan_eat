...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 05, 2019 at 03:46 PM
...
INSERT INTO `ingredient` (`barcode`, `name`, `last_refresh`, `kcal_100g`, `proteins_100g`, `sugars_100g`, `fat_100g`, `salt_100g`, `fiber_100g`) VALUES
...
INSERT INTO `recipe` (`id`, `title`, `owner`) VALUES
(1, 'Rød grød med fløde', 'john'),
(2, 'Frikadeller med brun sovs og kartofler', 'john'),
(3, 'Pebernødder', 'john'),
(4, 'Stegt flæsk med kartofler', 'john'),
(7, 'Rød grød med fløde', 'aaa'),
(8, 'Rød grød med fløde', 'aaa'),
(9, 'Rød grød med fløde', 'aaa');
...
CREATE TABLE IF NOT EXISTS `recipe_ingredient` (
  ...
  KEY `FK_recipe_ingredient_barcode_ingredient` (`barcode_ingredient`),
...
(1, 3029330003533, 456, 1),
(1, 5010477301246, 123, 1);
